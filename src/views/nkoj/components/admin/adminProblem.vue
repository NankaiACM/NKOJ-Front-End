...
<script>
import Editor from '../../bin/wangEditor.min.js'
// const Editor = () => import(/* webpackChunkName: "wang-editor" */ '../../bin/wangEditor.min.js')
export default {
  name: 'admin-problem',
  data: function () {
    return {
